...
class _HomeViewState extends State<HomeView> {
  ...
  List marketShareArr = [
    {"title": "Est.2025", "subtitle": "35%"},
    {"title": "Q4 2024", "subtitle": "30%"},
    {"title": "Q3 2024", "subtitle": "25%"},
    {"title": "Q2 2024", "subtitle": "18%"},
    {"title": "Q1 2024", "subtitle": "15%"},
  ];
                                ...
                                getTooltipItems:
                                  ...
                                  return lineBarsSpot.map((lineBarSpot) {
                                    return LineTooltipItem(
                                      "${lineBarSpot.x.toInt()}st Last Month",
                                      const TextStyle(
                                        color: Colors.white,
                                        fontSize: 10,
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              children: [
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: marketShareArr.map((wObj) {
                                    var isLast = wObj == marketShareArr.last;
                                    return Row(
                                      crossAxisAlignment:
